...
open class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
  ...
  var restPeriodRemaining: Int
  let updatePeriod: Int = 1 //How often the alertView should update the text for the restPeriod
  ...
  // Initializer
  public convenience init(title: String?, message: String?, preferredStyle: DOAlertControllerStyle, restPeriodRemaining: Int) {
    self.init(nibName: nil, bundle: nil)
    
    self.title = title
    self.message = message
    self.preferredStyle = preferredStyle
    self.restPeriodRemaining = restPeriodRemaining
